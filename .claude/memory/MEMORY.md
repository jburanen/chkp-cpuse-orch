...
- [MDS discovery command](mds-discovery-command.md) — call `$MDSDIR/scripts/mdsquerydb MDSs` (PATH is unreliable over SSH exec); SmartEvent on MDS confirmed via API login domain="Global"
